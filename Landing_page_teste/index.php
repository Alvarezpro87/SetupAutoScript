            ...
            <div class="container">
                <div class="site-header-inner">
                    ...
                    <ul class="header-links list-reset m-0">
                        ...
                        <li>
                            <a class="button button-sm button-shadow" href="#">usuário</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <section class="hero text-light text-center">
                <div class="container-sm">
                    <div class="hero-inner">
                        <h1 class="hero-title h2-mobile mt-0 is-revealing">Página de Negócio</h1>
                        <p class="hero-paragraph is-revealing">Página de negócios...........</p>
                        <p class="hero-cta is-revealing"><a class="button button-secondary button-shadow" href="#">COMECE AGORA</a></p>
            ...
            <section class="features section text-center">
                <div class="container">
                    <div class="features-inner section-inner has-top-divider">
                        <h2 class="section-title mt-0">Produtos</h2>
                ...
                <div class="container">
                    <div class="features-extended-inner section-inner has-top-divider">
                        <div class="features-extended-header text-center">
                            <div class="container-sm">
                                <h2 class="section-title mt-0">Sobre nós</h2>
                        ...
                        <div class="feature-extended">
                            ...
                            <div class="feature-extended-body">
                                <h3 class="mt-0">Descubra</h3>
                                <p>Texto para focar o cliente</p>
                            </div>
                        </div>
                        <div class="feature-extended">
                            <div class="feature-extended-image is-revealing">
            ...
            <section class="pricing section">
                <div class="container">
                    <div class="pricing-inner section-inner has-top-divider">
                        <h2 class="section-title mt-0 text-center">Preço</h2>
                            ...
                            <div class="pricing-table is-revealing">
                                <div class="pricing-table-inner">
                                    ...
                                    <div class="pricing-table-cta">
                                        <a class="button button-secondary button-block" href="#">Comece agora</a>
                                    </div>
                                </div>
                            </div>
                            <div class="pricing-table is-revealing">
                                <div class="pricing-table-inner">
                                    ...
                                    <div class="pricing-table-cta">
                                        <a class="button button-primary button-block" href="#">Comece agora</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <footer class="site-footer">
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <p>IP do Servidor: <?php echo $_SERVER['SERVER_ADDR']; ?></p>
                </div>
            </div>
        </footer>
    </div>
